        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
              손으로 만드는 것의 특별함을 믿습니다. 하나하나 정성스럽게 만든
              제품들은 기계로는 표현할 수 없는 따뜻함과 개성을 담고 있어요.
            </p>

            <p className="text-gray-600 mb-8 leading-relaxed">
              일상 속 작은 행복을 선사하는 핸드메이드 소품들로 여러분의
              하루하루가 더욱 특별해지길 바랍니다. 모든 제품은 친환경 소재를
              사용하여 지구도 생각하는 마음으로 만들고 있습니다.
            </p>
